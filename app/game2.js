...
(function (w) {
    ...
    p.onRotationStart = function (event) {
        ...
        if (detenido) {
            return; // Si el tiempo está detenido, salir de la función y no permitir la rotación
        }
    ...
    p.onRotationStop = function () {
        ...
        // Verifica si el ángulo actual es igual al ángulo deseado (por ejemplo, 95 grados)
        if (this._angle >= 160 && this._angle <= 190) {
            // Muestra una alerta cuando el ángulo está dentro del rango especificado al soltar el ratón
            isAngleReached = true;
